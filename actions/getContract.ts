...
import type { CountOccurrences, IsUnknown, UnionToIntersection } from "@/types/utils";
...
export type BaseInterface<
    Interface extends Record<keyof Pick<ethers.utils.Interface, InterfaceKeys>, unknown>
> = Omit<ethers.utils.Interface, InterfaceKeys> & Interface;

export type Contract<TAbi extends Abi, _Functions = Functions<TAbi>> = _Functions &
    BaseContract<{
        address: Address;
        ...
        populateTransaction: Functions<TAbi, { ReturnType: ethers.PopulatedTransaction }>;
...
export type InterfaceFunctions<TAbi extends Abi> = UnionToIntersection<
    {
        [K in keyof TAbi]: TAbi[K] extends infer TAbiFunction extends AbiFunction & {
            type: "function";
        }
...
export type InterfaceEvents<TAbi extends Abi> = UnionToIntersection<
    {
